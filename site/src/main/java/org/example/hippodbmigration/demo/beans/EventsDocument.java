...
@HippoEssentialsGenerated(internalName = "hippodbmigrationdemo:eventsdocument")
@Node(jcrType="hippodbmigrationdemo:eventsdocument")
public class EventsDocument extends HippoDocument {

    /**
     * The document type of the events document.
     */
    public final static String DOCUMENT_TYPE = "hippodbmigrationdemo:eventsdocument";
    ...
    private final static String END_DATE = "hippodbmigrationdemo:enddate";
     ...
     * @return the end date
     */
    @HippoEssentialsGenerated(internalName = "hippodbmigrationdemo:enddate")
